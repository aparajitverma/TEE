    ...
    try {
      ...
      if (data.client) {
        ...
        setFormData({
          ...
          taxId: client.taxId || '',
          paymentTermsPreferred: client.paymentTermsPreferred || '',
          creditLimit: client.creditLimit || 0,
          currencyPreferred: client.currencyPreferred || 'USD',
          leadSource: client.leadSource || '',
          leadStatus: client.leadStatus || 'New',
          leadTemperature: client.leadTemperature || 'Warm',
          probabilityToClose: client.probabilityToClose || 50,
          expectedOrderValue: client.expectedOrderValue || 0,
          notes: client.notes || '',
        });
      }
    } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert('Failed to update client: ' + (error.details || error.error));
      }
    } catch (error) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-400">Update client information</p>
          </div>
        </div>
